module.exports = {
	...
	notes: 'You can write the whole month, or use the first three letters. Single dates can be with or without the zero. (6 or 06 is fine.)\nExamples: !present July 4 (Present on July 4 -- removes an absence for just that date)\n!present Jul 4 Jul 21 (Present from July 4 until July 21 -- removes any absence that matches this start and end date.',
