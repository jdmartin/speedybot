...
export const data = new SlashCommandBuilder().setName("info").setDescription("Answers to all your burning questions...")
...
export async function execute(interaction) {
    switch (interaction.options.getSubcommand()) {
        ...
        case 'attendance':
            ...
            break;
        case 'corkboard':
            let corkEmbed = new EmbedBuilder()
                .setColor(0xFFFFFF)
            ...
            break;
        case 'crafter':
            let craftEmbed = new EmbedBuilder()
                .setColor(0xFFFFFF)
